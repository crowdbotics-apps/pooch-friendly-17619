"""pooch_friendly_17619 URL Configuration
...
admin.site.site_header = "Pooch Friendly"
admin.site.site_title = "Pooch Friendly Admin Portal"
admin.site.index_title = "Pooch Friendly Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Pooch Friendly API",
        default_version="v1",
        description="API documentation for Pooch Friendly App",
    ),
    public=True,
